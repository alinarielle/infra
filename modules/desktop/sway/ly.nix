{pkgs, lib, ...}: {
  services.displayManager.ly = {
    ...
    settings = {
      ...
      brightness_down_cmd = "${lib.getExe pkgs.brightnessctl} -q s 5%-";

      # Brightness decrease key, or null to disable
      brightness_down_key = "F5";

      # Brightness increase command
      brightness_up_cmd = "${lib.getExe pkgs.brightnessctl}  -q s +5%";
      ...
      waylandsessions = "${pkgs.swayfx}/share/wayland-sessions";
