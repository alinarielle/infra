...
}:
{
  ...
  config.l.network.ipgen = lib.mapAttrs (
    key: val:
    let
      ...
      dividend =
        ...
        lib.toIntBase10 (
          builtins.substring 0 19 (
            builtins.replaceStrings abc (lib.imap (int: v: builtins.toString int) abc) (
      ...
      v4 = {
        ...
        private = fun.ipv4.encode (
          (fun.ipv4.decode "10.0.0.0") + (lib.mod dividend (fun.ipv4.decode "0.255.255.255"))
        );
        #privateCIDR = "/32";
      };
      v6 = {
