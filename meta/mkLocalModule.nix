{lib, config, ...}: { config.l.lib = rec {
    ...
    */
    mkLocalModule = currentPath: optDesc: moduleConfig: mkLocalModuleMarker (findFolderWithFile "flake.nix" currentPath) ["l"] currentPath optDesc moduleConfig;
};}
