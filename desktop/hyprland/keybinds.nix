...
{ config, pkgs, lib, ... }: {
  ...
  home-manager.users.alina.wayland.windowManager.hyprland.keyBinds = 
    ...
    groups = {
      ...
      killWindow = { bind."SUPER_SHIFT, Q" = "killactive,"; };
  ...
  in lib.mkMerge [
    ...
    ### MISCELLANEOUS ###
    {
      ...
      bind."SUPER_SHIFT, X" = "exec, poweroff";
      
      # Reboot the device
      bind."SUPER_SHIFT, Y" = "exec, reboot";
    }
    ### PROGRAM LAUNCHING ###
    groups.launchPrograms
    {
      ...
      # Open sway-launcher-desktop to launch a .desktop file or run a command.
    ...
    ### FUNCTION KEYS ###
    {
      ...
      bindel.", XF86MonBrightnessUp" = "exec, ${exec.brightnessctl} set +5%";
      bindel.", XF86MonBrightnessDown" = "exec, ${exec.brightnessctl} set 5%-";
